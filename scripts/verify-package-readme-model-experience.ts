...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/memory/dsh-memory': { kind: 'indirect', reason: 'The git store service delegates model request rendering to dsh-tool-memory and the context/accumulate consumers.' },
  ...
  'packages/skill/rin-filesystem': { kind: 'indirect', reason: 'The hierarchical provider delegates catalog and body rendering to dsh-tool-skill.' },
